...
const fetchMotor1Data = async () => {
  try {
    const response = await axios.get('http://localhost:8000/api/arm_robot_detail_motor1')
...
const fetchMotor2Data = async () => {
  try {
    const response = await axios.get('http://localhost:8000/api/arm_robot_detail_motor2')
...
const fetchMotor3Data = async () => {
  try {
    const response = await axios.get('http://localhost:8000/api/arm_robot_detail_motor3')
...
const fetchMotor4Data = async () => {
  try {
    const response = await axios.get('http://localhost:8000/api/arm_robot_detail_motor4')
